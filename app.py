from flask import Flask, flash, render_template, url_for, request, redirect #importlar bunlar ee dewam 
from flask_sqlalchemy import SQLAlchemy #sql data basedir os sistem islemlewri yapmak icin kullanilir
import os
